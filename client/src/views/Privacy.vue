<template>
  <div class="privacy">
    ...
    <p>
      ...
      den Nutzern die erforderlichen Pflichtangaben mitgeteilt und zu Zwecken
    ...
    <p>
      ...
      Speicherung erfolgt auf Grundlage unserer berechtigten Interessen als auch
